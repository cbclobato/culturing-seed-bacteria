...
FigS8 <- cowplot::plot_grid(ev, vc1, vc2, 
                           labels = c("B", "C", "D"),
                           label_size = 12,
                           hjust = 1.5,
                           ncol = 1,
...
FigS8_final <- cowplot::plot_grid(biplot, FigS8,labels = c("A", ""),
                           label_size = 12,
                           rel_heights = c(0.2, .8),
                           rel_widths = c(1, .7),
                           scale = c(0.75, 1),
                           ncol = 2,
                           align = "hv") +
   theme(plot.margin = margin(0,0,0,0, "cm")); FigS8_final

cowplot::save_plot(plot = FigS8_final,
